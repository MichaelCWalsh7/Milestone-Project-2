...
-   #### Returning Visitor Goals
    1. As a Returning Visitor, I want to understand further nuances in the game.
        - While the rules are cleary displayed multiple times on the site, there are some extra nuances to the game that a player might miss from only skimming the rules.
        - For example, no abbreaviations are allowed, words must be a minumum of three letters long, words cannot repreat etc.
    ...
    3. As a Returning Visitor, I want to contact the user with any questions or queries that I may have with the 
        ...
        - Ever present in the navbaris an information circle symbol. Clicking on this will take the user to an "info/contact" page.
    ...
    4. As a Returning Visitor, I want to be able to play the game using my keyboard as well the letter buttons provided.
        - Everytime an angram is generated into the letter buttons, event listeners are also generated.
...
-   #### Frequent User Goals
    1. As a Frequent User, I want to easily check to see if there are any newly added game modes or challenges
        ...
        - The offcanvas has a lot of unsed space that could be used for an alert
    ...
    3. As a Frequent User, I want to reset the game at any time, if I win, lose or am in the middle of a game.
        - Another aspect of the gmae that was difficult to balance was restting. Having no option to reset would be a bad user experience. However, allowing arbritary resets would mean the user could jsut reroll for whatever letters they preffered.
